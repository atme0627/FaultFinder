...
class SuspiciousVariableFinderTest {
    ...
    void find1() throws NoSuchFileException {
        ...
        SuspiciousVariableFinder finder
                = new SuspiciousVariableFinder(new MethodElementName("sample.MethodCallTest#methodCall1()"));
    ...
    void findD4j1() throws NoSuchFileException {
        ...
        TestUtil.compileForDebug(new MethodElementName("org.apache.commons.math3.distribution.HypergeometricDistributionTest"));
        SuspiciousVariableFinder finder
                = new SuspiciousVariableFinder(new MethodElementName(testMethodName));
        List<SuspiciousVariable> result = finder.find();
        result.forEach(vi -> System.out.println(vi.toString()));
    }
}