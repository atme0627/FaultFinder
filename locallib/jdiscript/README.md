...
For more, see the included [examples](../src4test/src/example/java/org/jdiscript/example).
...
- Classes that handle the boilerplate of [launching](../src4test/src/main/java/org/jdiscript/util/VMLauncher.java) or [attaching to](../src4test/src/main/java/org/jdiscript/util/VMSocketAttacher.java) a [VirtualMachine](http://download.java.net/jdk8/docs/jdk/api/jpda/jdi/index.html?com/sun/jdi/VirtualMachine.html).

- A [JDIScript class](../src4test/src/main/java/org/jdiscript/JDIScript.java) that ties it all together and provides convenience methods for common script patterns.
